...
# item array. This method is destructive, meaning it mutates the object that it's called on.
# We can find this out by testing in irb and checking the Ruby docs.